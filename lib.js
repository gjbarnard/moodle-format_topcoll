//  $Id: lib.js,v 1.3.2.4 2010/04/03 19:24:25 gb2048 Exp $
...
function topcoll_init(wwwroot, moodleid, courseid)
{
	// Init.
	thewwwroot = wwwroot;
...
function savetopcollcookie(value)
{
	...
	yuicookie.setSub("mdl_cf_topcoll",thecookiesubid,value);  // This is not a Moodle table but in fact the cookies name.
}
