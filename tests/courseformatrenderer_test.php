...
class format_topcoll_courseformatrenderer_testcase extends advanced_testcase {
    ...
    public function test_section_header() {
        ...
        $theclass = format_topcoll_courseformatrenderer_testcase::call_method($this->outputus, 'section_header',
            array($section, $this->course, $onsectionpage));
        $thevalue = '<li id="section-1" class="section main clearfix span12" role="region" aria-label="Section 1"><div class=';
        $thevalue .= '"left side"><span class="cps_centre">1</span></div><div class="right side"><span class="cps_centre">Topic';
        $thevalue .= '<br />1</span></div><div class="content"><div class="summary"></div>';
    ...
    public function test_toggle_all() {
        $theclass = format_topcoll_courseformatrenderer_testcase::call_method($this->outputus, 'toggle_all',
            array());
        $thevalue = '<li class="tcsection main clearfix" id="toggle-all"><div class="left side"><img width=';
        $thevalue .= '"1" height="1" class="spacer" alt="" src="';
        $thevalue .= 'http://www.example.com/moodle/theme/image.php/_s/clean/core/1/spacer" /></div><div ';
        $thevalue .= 'class="right side"><img width="1" height="1" class="spacer" alt="" src="';
        $thevalue .= 'http://www.example.com/moodle/theme/image.php/_s/clean/core/1/spacer" /></div><div class=';
        $thevalue .= '"content"><div class="sectionbody toggle-arrow-hover toggle-arrow"><h4><a class="on tc-medium" ';
        $thevalue .= 'href="#" id="toggles-all-opened">Open all</a><a class="off tc-medium" href="#" id="toggles-all-closed';
    ...
    public function test_display_instructions() {
        $theclass = format_topcoll_courseformatrenderer_testcase::call_method($this->outputus, 'display_instructions',
            array());
        ...
        $thevalue .= 'http://www.example.com/moodle/theme/image.php/_s/clean/core/1/spacer" /></div><div class="';
        $thevalue .= 'right side"><img width="1" height="1" class="spacer" alt="" src="';
