...
class format_topcoll_courseformatrenderer_testcase extends advanced_testcase {
    ...
    public function test_print_multiple_section_page() {
        ...
        $theoutput .= 'row-fluid"><li id="section-1" class="section main clearfix span12" role="region" ';
    ...
    public function test_toggle_all() {
        $theclass = format_topcoll_courseformatrenderer_testcase::call_method($this->outputus, 'toggle_all',
            array());
        $thevalue = '<li class="tcsection main clearfix" id="toggle-all"><div class="left side"><img width="1" ';
        $thevalue .= 'height="1" class="spacer" alt="" title="" src="';
        $thevalue .= 'http://www.example.com/moodle/theme/image.php/_s/clean/core/1/spacer" /></div><div class=';
        $thevalue .= '"right side"><img width="1" height="1" class="spacer" alt="" title="" src="';
    ...
    public function test_display_instructions() {
        ...
        $thevalue .= '<img width="1" height="1" class="spacer" alt="" title="" src="';
